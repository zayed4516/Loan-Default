...
with st.form("loan_form"):
    ...
    with col2:
        ...
        EmploymentType = st.selectbox("Employment Type", [0, 1, 2])  # Example encoding
        ...
        LoanPurpose = st.selectbox("Loan Purpose", [0, 1, 2, 3])  # Example encoding
